...
VALUES (1, 'Vasya', 'Pupkin', '0935588774', 'vpupkin@gmail.com', 'vpupkin', '12345', 1, '12.08.2018 12:00:01',
        '07.09.2018 : 10:10:10');

INSERT INTO Users (id, f_name, l_name, phone, email, nick_name, password, status, registration_date, last_update_date)
VALUES (2, 'John', 'Conor', '88003553555', 'admin@gmail.com', 'admin', 'qwerty', 1, '12.06.2018 12:00:01',
        '02.09.2018 : 10:10:10');

INSERT INTO Users (id, f_name, l_name, phone, email, nick_name, password, status, registration_date, last_update_date)
VALUES (3, 'Sara', 'Conor', '88004557564', 'saraloveterminator@gmail.com', 'saraConor', 'skynetsuck', 1,
